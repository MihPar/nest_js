...
import {
  CommentViewModel,
  inputModeContentType,
} from 'src/api/comment/comment.type';
...
//     @Param() postId: string,
//     @Body() inputModeLikeStatus: likeStatusType,
//   ) {
...
//       inputModeLikeStatus.likeStatus,
//       postId,
//       userId,
//       userLogin,
//     );
...
//     @Param('postId') postId: string,
//     @Body() inputDataContetn: inputModeContentType,
//   ) {
//     const user = req.user;
//     const post: Posts | null = await this.postsQueryRepository.findPostById(
//       postId,
//     );
...
//       await this.postsQueryRepository.findPostById(req.params.id, userId);
//   }
